    ...
    <table>
        ...
        <tbody>
            <?php
                ...
                $stmt = $conn->prepare("SELECT libros.id, libros.titulo, libros.isbn, libros.anio_publicacion,libros.editorial, libros.cantidad, libros.disponibles, categorias.nombre AS categoria FROM libros INNER JOIN categorias ON libros.id_categoria = categorias.id;");
                $stmt->execute();
